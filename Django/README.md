...
* **auth_group**, **auth_group_permissions**, **auth_permission**, **auth_user**, **auth_user_groups**, **auth_user_user_permissions** - это таблицы, которые связаны с аутентификацией и авторизацией в Django.
