...
- [Django ORM](#django-orm)
  - [1. Создание проекта](#1-создание-проекта)
    - [1.1. Подготовка проекта](#11-подготовка-проекта)
    - [1.2. Знакомство с CLI django-admin](#12-знакомство-с-cli-django-admin)
    - [1.3. Создание нового проекта](#13-создание-нового-проекта)
    - [1.4. Создание нового приложения](#14-создание-нового-приложения)
    - [1.5. Добавление нового приложения](#15-добавление-нового-приложения)
