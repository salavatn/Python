...
- **Оглавление:**
  - [1. Создание проекта](#1-создание-проекта)
    - [1) Подготовка проекта](#11-подготовка-проекта)
    - [2) Знакомство с CLI django-admin](#12-знакомство-с-cli-django-admin)
    - [3) Создание нового проекта](#13-создание-нового-проекта)
    - [4) Создание нового приложения](#14-создание-нового-приложения)
    - [5) Добавление нового приложения](#15-добавление-нового-приложения)
  - [2. Подключение к Базе Данных](#2-подключение-к-базе-данных)
    - [Добавить подключение к БД PostgreSQL](#добавить-подключение-к-бд-postgresql)
    - [Добавить модели для PostgreSQL](#добавить-модели-для-postgresql)
    - [Создать миграции](#создать-миграции)
...
### 1.2) Знакомство с CLI django-admin
...
### 1.5) Добавление нового приложения
