...
# =================
def parser_hh(keywords, page = 0):
    # Получаем весь HTML код страницы
    url     = f'https://hh.ru/search/vacancy?search_field=name&enable_snippets=true&text={keywords}&page={page}'
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)'}
...
while True:
    ...
    for card in parser_hh('python', page):
